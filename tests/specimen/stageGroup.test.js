...
const unitTests = [
  [
    ...
    loadObjects(specimen, {
      pathological_staging_system: 'revised international staging system (riss)',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'lugano staging system',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'St Jude staging System',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'Ann Arbor Staging System',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: ' rai Staging syStem ',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: ' Durie-salmon Staging syStem ',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'FIGO Staging syStem ',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: ' binEt stAging SYSTEM',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'AJCC 8th Edition',
  ...
  [
    ...
    true,
    loadObjects(specimen, {
      pathological_staging_system: 'AJCC 7th edition',
  ...
  [
    ...
    false,
    loadObjects(specimen, {
      pathological_staging_system: 'my staging system',
  ...
  [
    ...
    false,
    loadObjects(specimen, {
      pathological_staging_system: 'default',
    }),
  ],
